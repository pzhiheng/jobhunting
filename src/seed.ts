 ...
 *  Posted dates are relative so the mocks never hit the 15-day age-out. */
...
const MOCK_JOBS: NormalizedJob[] = [
  {
    ...
    salaryMin: 160000, salaryMax: 210000, category: "swe", postedAt: daysAgo(1),
  },
  {
    ...
    salaryMin: 150000, salaryMax: 200000, category: "mle", postedAt: daysAgo(2),
  },
  {
    ...
    salaryMin: 140000, salaryMax: 190000, category: "swe", postedAt: daysAgo(3),
  },
  {
    ...
    salaryMin: 170000, salaryMax: 230000, category: "mle", postedAt: daysAgo(4),
  },
];
